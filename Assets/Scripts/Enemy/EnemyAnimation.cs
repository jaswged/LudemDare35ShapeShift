...
public class EnemyAnimation : MonoBehaviour 
{
    ...
    private EnemyScript enemySight;
...
//    private AnimatorSetu animSetup;		    // An instance of the AnimatorSetup helper class.
...
//        player = GameObject.FindGameObjectWithTag(DoneTags.player).transform;
        ...
        enemySight = GetComponent<EnemyScript>();

        nav = GetComponent<NavMeshAgent>();
        anim = GetComponent<Animator>();
        //hash = GameObject.FindGameObjectWithTag(DoneTags.gameController).GetComponent<DoneHashIDs>();
 //       hash = GameObject.FindGameObjectWithTag(DoneTags.player).GetComponent<DoneHashIDs>();
 ...
 //       animSetup = new AnimatorSetu(anim, hash);
